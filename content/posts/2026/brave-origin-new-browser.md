...
| Mode | How it works | What happens to extra features |
| --- | --- | --- |
| Standalone app | Separate Brave Origin install | Features are compiled out entirely |
| Upgrade mode | Existing Brave gets an Origin settings panel | Features are toggled off by default |
...
| Platform | Upgrade | Standalone | One-time purchase | Free option |
| --- | --- | --- | --- | --- |
| Android (1.91.x+) | Yes | No | Yes | No |
| iOS (1.91.x+) | Yes | No | Yes | No |
| macOS (1.91.x+) | Yes | Yes | Yes | No |
| Windows (1.91.x+) | Yes | Yes | Yes | No |
| Linux (1.91.x+) | Yes | Yes | Yes | Yes |
...
- Official Brave Help Center article: What is Brave Origin <https://support.brave.app/hc/en-us/articles/38561489788173-What-is-Brave-Origin>
- Version and availability details reflect Brave documentation at publication time
