...
- `ujust` - Main cli command for installing and managing software packages. It is a user-friendly package manager that simplifies the process of installing and updating software on Bazzite.
  - `ujust --choose` will show all commands
- `bazaar` - GUI tool for installing and managing flatpak software in Bazzite. Based on <https://github.com/bazaar-org/bazaar>
- `brew` - Homebrew modified for bazzite - <https://docs.bazzite.gg/Installing_and_Managing_Software/Homebrew/>
- Containers from `distrobox` and `quadlet` - Install anything inside of a container using any package manager - <https://docs.bazzite.gg/Installing_and_Managing_Software/Containers/>
