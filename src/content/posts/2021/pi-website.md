...
_IMPORTANT: Exit SQL Prompt with `Ctrl + D` and change `YOURPASSWORD` above to your password!_
...
In the _WP Admin Portal_:

- Go to _Setting_, then _Permalinks_
- Select the _Post name_ option and click _Save Changes_

From _SSH or Terminal on the RPI_ you need to enter the following:
