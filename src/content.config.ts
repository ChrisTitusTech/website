...
const dateValue = z.string().refine(
  (value) =>
...
const tableValue = z.array(z.array(z.union([z.string(), z.number(), z.boolean()])));
...
const shared = z
  .object({
    ...
    featuredOrder: z.union([z.literal(1), z.literal(2), z.literal(3)]).optional(),
